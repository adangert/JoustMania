...
**Indoor gameplay assessment:** internal Pi Bluetooth worked pretty well for the two ZCM2 (PS4 Move) controllers tested. It is the basis for the proposed Tier 1 indoor setup; its five-ZCM2 target and endurance remain untested. Internal Bluetooth is not recommended for PS3 Move gameplay because the recorded timing was poor, particularly under heavier load.
