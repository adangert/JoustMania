...
from wtforms import BooleanField, FieldList, Form, SelectField, SelectMultipleField, widgets
...
class SettingsForm(Form):
    ...
    sensitivity = SelectField(
        "Move sensitivity",
        choices=[(0, "Ultra High"), (1, "High"), (2, "Medium"), (3, "Low"), (4, "Ultra Low")],
        coerce=int,
    )
    mode_selection = SelectField(
        "Mode selection", choices=[game.pretty_name for game in common.Games], coerce=str
    )
    mode_options = [
        game for game in common.Games if game not in [common.Games.Random, common.Games.JoustTeams]
    ]
