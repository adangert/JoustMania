...
def state_based_track_move(
    ...
    while not kill_proc.value:
        ...
        if restart.value == 1:
            ...
            logger.debug(f"Tracking Move (Menu): {move_serial}")
            ...
            logger.debug(
                f"Track Move ({common.get_game_name(game_mode.value)}): {move_serial}"
            )
            ...
            if game_mode.value == common.Games.Tournament.value:
                ...
                game.Game.track_move_state_based(
                    ...
                    move=move,
                    team=team,
                    team_color_enum=team_color_enum,
                    dead_move=dead_move,
                    invincible_move=invincible_move,
